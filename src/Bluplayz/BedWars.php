    ...
    public function onEnable(){
        ...
        if ($shop->get("Shop") == null) {
                $shop->set("Shop", array(
                    ...
                    array(
                        array(
                            Item::SANDSTONE, 5, 384, 4
                        ),
                        array(
                            Item::GLASS, 1, 384, 20
                        ),
                        array(
                            Item::OBSIDIAN, 1, 384, 200
                        )
                    ),
					Item::WOODEN_PICKAXE,
                    array(
                        array(
                            Item::WOODEN_PICKAXE, 1, 384, 10
                        ),
                        array(
                            Item::STONE_PICKAXE, 1, 384, 20
                        ),
                        array(
                            Item::IRON_PICKAXE, 1, 384, 100
                        ),
                        array(
                            Item::DIAMOND_PICKAXE, 1, 384, 400
                        )
                    ),
					Item::WOODEN_SWORD,
                    array(
                        array(
                            Item::WOODEN_SWORD, 1, 384, 10
                        ),
                        array(
                            Item::STONE_SWORD, 1, 384, 20
                        ),
                        array(
                            Item::IRON_SWORD, 1, 384, 100
                        ),
                        array(
                            Item::DIAMOND_SWORD, 1, 384, 400
                        )
                    ),
                    Item::IRON_CHESTPLATE,
                    array(
                        array(
                            Item::LEATHER_CAP, 1, 384, 5
                        ),
                        array(
                            Item::LEATHER_PANTS, 1, 384, 5
                        ),
                        array(
                            Item::LEATHER_BOOTS, 1, 384, 5
                        ),
                        array(
                            Item::LEATHER_TUNIC, 1, 384, 5
                        ),
						array(
                            Item::CHAIN_CHESTPLATE, 1, 384, 50
                        ),
						array(
                            Item::IRON_CHESTPLATE, 1, 384, 200
                        ),
                        array(
                            Item::DIAMOND_CHESTPLATE, 1, 384, 500
                        )
                    )
                )
            );
        ...
        if($player instanceof Player){
            if($this->inArena($player)){
                ...
                if(!in_array($event->getItem()->getId(), $this->pickup)) {
                    ...
                    if ($event->getItem()->getItem()->getId() == Item::DIAMOND) {
                        $event->setCancelled();
                        $player->getLevel()->removeEntity($event->getItem());
                        $this->pickup[] = $event->getItem()->getId();
                        $player->setExpLevel($player->getExpLevel() + 10);
                        $player->sendTip(TextFormat::GOLD . "+" . TextFormat::GREEN . "50 Level!");
                    }
