...
class Bedwars extends PluginBase implements Listener {
    ...
    public function onEnable(){
        ...
        $this->getLogger()->info($this->prefix.TextFormat::GREEN."BedWars_Insane_Mode plugin by NetherTechnology loaded!");
        ...
        if ($shop->get("Shop") == null) {
                $shop->set("Shop", array(
                    ...
                    array(
                        array(
                            Item::SANDSTONE, 64, 336, 1
                        ),
                        array(
                            Item::GLASS, 12, 336, 5
                        ),
                        array(
                            Item::OBSIDIAN, 2, 264, 1
                        )
                    ),
					Item::WOODEN_PICKAXE,
                    array(
                        array(
                            Item::WOODEN_PICKAXE, 1, 336, 1
                        ),
                        array(
                            Item::STONE_PICKAXE, 1, 265, 1
                        ),
                        array(
                            Item::IRON_PICKAXE, 1, 266, 5
                        ),
                        array(
                            Item::DIAMOND_PICKAXE, 1, 264, 2
                        )
                    ),
					Item::BREAD,
                    array(
                        ...
                        array(
                            Item::GOLDEN_APPLE, 2, 264, 1
                        )
                    ),
					Item::EXPERIENCE_BOTTLE,
                    array(
                        array(
                            Item::EXPERIENCE_BOTTLE, 64, 264, 2
                        ), 
                        array(
                            Item::ENCHANTING_TABLE, 1, 264, 5
                        )
                    ),
					Item::BOW,
                    array(
                    ...
                    array(
                        array(
                            Item::WOODEN_SWORD, 1, 336, 1
                        ),
                        array(
                            Item::STONE_SWORD, 1, 265, 1
                        ),
                        array(
                            Item::IRON_SWORD, 1, 265, 5
                        ),
                        array(
                            Item::DIAMOND_SWORD, 1, 264, 2
                        )
                    ),
                    Item::IRON_CHESTPLATE,
                    array(
                        array(
                            Item::LEATHER_CAP, 1, 336, 1
                        ),
                        array(
                            Item::LEATHER_PANTS, 1, 336, 1
                        ),
                        array(
                            Item::LEATHER_BOOTS, 1, 336, 1
                        ),
                        array(
                            Item::LEATHER_TUNIC, 1, 336, 1
                        ),
						array(
                            Item::CHAIN_CHESTPLATE, 1, 265, 1
                        ),
						array(
                            Item::IRON_CHESTPLATE, 1, 265, 10
                        ),
                        array(
                            Item::DIAMOND_CHESTPLATE, 1, 266, 2
                        )
                    )
                )
            );
                            ...
                            foreach ($tiles as $tile) {
                                if ($tile instanceof Sign) {
                                    ...
                                    if (strtolower($text[0]) == "Exp" || strtolower($text[1]) == "Exp" || strtolower($text[2]) == "Exp" || strtolower($text[3]) == "Exp") {
                                        $level->dropItem(new Vector3($tile->getX() + 0.5, $tile->getY() + 2, $tile->getZ() + 0.5), Item::get(Item::EXPERIENCE_BOTTLE, 0, 5));
										$level->dropItem(new Vector3($tile->getX() + 0.5, $tile->getY() + 2, $tile->getZ() + 0.5), Item::get(Item::EXPERIENCE_BOTTLE, 0, 5));
										$level->dropItem(new Vector3($tile->getX() + 0.5, $tile->getY() + 2, $tile->getZ() + 0.5), Item::get(Item::EXPERIENCE_BOTTLE, 0, 5));
                                    }
                                }
